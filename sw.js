...
const CACHE = "zh-beginner-a-v128";
const ASSETS = [
  "./",
  "./index.html",
  "./app.js?v=128",
  ...
  "./images/dragon-teacher.png?v=128",
  "./images/dragon-celebrate.png?v=128",
  "./images/dragon-thinking.png?v=128",
  "./images/dragon-sad.png?v=128",
  "./images/dragon-idle.png?v=128",
  "./images/dragon-waving.png?v=128",
  "./images/sprite-reading.png?v=128",
  "./images/sprite-ox-baozi.png?v=128",
  "./images/sprite-panda-puzzled.png?v=128",
  "./images/sprite-panda-baozi.png?v=128",
  "./images/sprite-joy.png?v=128",
  "./images/sprite-baozi.png?v=128",
  "./images/sprite-puzzled.png?v=128",
  "./sounds/correct.mp3?v=128",
  "./sounds/wrong.mp3?v=128",
  "./sounds/complete.mp3?v=128",
  "./sounds/goal.mp3?v=128"
];
