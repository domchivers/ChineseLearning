...
const CACHE = "zh-beginner-a-v160";
const ASSETS = [
  "./",
  "./index.html",
  "./app.js?v=160",
  ...
  "./images/panda-teacher.png?v=160",
  "./images/panda-celebrate.png?v=160",
  "./images/panda-sad.png?v=160",
  "./images/panda-idle.png?v=160",
  "./images/panda-waving.png?v=160",
  "./images/panda-peek.png?v=160",
  "./images/sprite-reading.png?v=160",
  "./images/sprite-baozi.png?v=160",
  "./images/sprite-writing.png?v=160",
  "./images/sprite-listening.png?v=160",
  "./images/sprite-puzzled.png?v=160",
  "./images/sprite-sleeping.png?v=160",
  "./images/welcome-light.webp?v=160",
  "./images/welcome-dark.webp?v=160",
  "./images/card-light.webp?v=160",
  "./images/card-dark.webp?v=160",
  "./vendor/fonts/nunito-latin.woff2",
  "./sounds/correct.mp3?v=160",
  "./sounds/wrong.mp3?v=160",
  "./sounds/complete.mp3?v=160",
  "./sounds/goal.mp3?v=160"
];
