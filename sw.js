...
const CACHE = "zh-beginner-a-v162";
const ASSETS = [
  "./",
  "./index.html",
  "./app.js?v=162",
  ...
  "./images/panda-teacher.png?v=162",
  "./images/panda-celebrate.png?v=162",
  "./images/panda-sad.png?v=162",
  "./images/panda-idle.png?v=162",
  "./images/panda-waving.png?v=162",
  "./images/panda-peek.png?v=162",
  "./images/sprite-reading.png?v=162",
  "./images/sprite-baozi.png?v=162",
  "./images/sprite-writing.png?v=162",
  "./images/sprite-listening.png?v=162",
  "./images/sprite-puzzled.png?v=162",
  "./images/sprite-sleeping.png?v=162",
  "./images/welcome-light.webp?v=162",
  "./images/welcome-dark.webp?v=162",
  "./images/card-light.webp?v=162",
  "./images/card-dark.webp?v=162",
  "./vendor/fonts/nunito-latin.woff2",
  "./sounds/correct.mp3?v=162",
  "./sounds/wrong.mp3?v=162",
  "./sounds/complete.mp3?v=162",
  "./sounds/goal.mp3?v=162"
];
