...
const CACHE = "zh-beginner-a-v159";
const ASSETS = [
  "./",
  "./index.html",
  "./app.js?v=159",
  ...
  "./images/panda-teacher.png?v=159",
  "./images/panda-celebrate.png?v=159",
  "./images/panda-sad.png?v=159",
  "./images/panda-idle.png?v=159",
  "./images/panda-waving.png?v=159",
  "./images/panda-peek.png?v=159",
  "./images/sprite-reading.png?v=159",
  "./images/sprite-baozi.png?v=159",
  "./images/sprite-writing.png?v=159",
  "./images/sprite-listening.png?v=159",
  "./images/sprite-puzzled.png?v=159",
  "./images/sprite-sleeping.png?v=159",
  "./images/welcome-light.webp?v=159",
  "./images/welcome-dark.webp?v=159",
  "./images/cont-light.webp?v=159",
  "./images/card-dark.webp?v=159",
  "./vendor/fonts/nunito-latin.woff2",
  "./sounds/correct.mp3?v=159",
  "./sounds/wrong.mp3?v=159",
  "./sounds/complete.mp3?v=159",
  "./sounds/goal.mp3?v=159"
];
