...
(() => {
  ...
  function mascotSpeech(face, src) {
    ...
    speech.appendChild(el("img", { className: "quiz-dragon", src: src || "images/path/panda-teacher.webp?v=181", alt: "" }));
  ...
  function buildSentenceExercise(face, host, sent, labelEl, onResult) {
    ...
    studyCheckFn = () => {
      ...
      if (drg) { drg.src = correct ? "images/path/panda-celebrate.webp?v=181" : "images/path/panda-sad.webp?v=181"; drg.classList.add("react"); }
      onResult(correct);
  ...
  function buildChoiceExercise(face, choicesBox, c, dir, labelEl, onResult) {
    ...
    options.forEach(opt => {
      ...
      btn.addEventListener("click", () => {
        ...
        const drg = face.querySelector(".quiz-dragon");
        if (correct) { btn.classList.add("correct"); if (drg) { drg.src = "images/path/panda-celebrate.webp?v=181"; drg.classList.add("react"); } }
        else {
          btn.classList.add("wrong");
          [...choicesBox.children].forEach(ch => { if (ch.dataset.val === answerText) ch.classList.add("correct"); });
          if (drg) { drg.src = "images/path/panda-sad.webp?v=181"; drg.classList.add("react"); }
        }
        onResult(correct);
      });
